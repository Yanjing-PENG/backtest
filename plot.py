...
def plot_net_value(orderbook, start_time, end_time, start_net_value):
    """
    ...
    pltoff.plot(fig, filename=os.getcwd() + '/result/' + 'net_value_' + start_time.split(' ')[0].replace('-', '') + '-' + end_time.split(' ')[0].replace('-', '') + '.html')
